#!/bin/bash
# DTU HPC job script — FairCV gender audit, Fanar-2 27B Instruct, 24h wall time
# Extended wall time needed: model scored ~825/4800 in 8h on A100 (~48h total needed).
#
# Submit:  bsub < run_faircv_fanar2_27b_a10.sh
#
# ── LSF directives ────────────────────────────────────────────────────────────
#BSUB -J faircv-fanar2-27b-24h
