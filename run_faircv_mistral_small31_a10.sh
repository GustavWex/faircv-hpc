#!/bin/bash
# DTU HPC job script — FairCV gender audit, Mistral Small 3.1 24B Instruct, A10 queue
#
# Submit:  bsub < run_faircv_mistral_small31_a10.sh
#
# ── LSF directives ────────────────────────────────────────────────────────────
#BSUB -J faircv-mistral-s31-a10
